...
func (h *ProductCategoryHandler) Create(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusCreated, models.WebResponse{Success: true, Message: "Relation created successfully", Data: nil})
}
...
func (h *ProductCategoryHandler) GetAll(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusOK, models.WebResponse{Success: true, Message: "Relations retrieved", Data: data})
}
...
func (h *ProductCategoryHandler) GetByID(ctx *gin.Context) {
	...
	if err != nil {
		ctx.JSON(http.StatusNotFound, models.WebResponse{Success: false, Message: "Relation not found", Data: nil})
		return
	}
	ctx.JSON(http.StatusOK, models.WebResponse{Success: true, Message: "Relation found", Data: data})
}
...
func (h *ProductCategoryHandler) Update(ctx *gin.Context) {
	...
	if errP != nil || errC != nil {
		ctx.JSON(http.StatusBadRequest, models.WebResponse{Success: false, Message: "Old Product ID and Category ID are required", Data: nil})
		return
	}
	...
	ctx.JSON(http.StatusOK, models.WebResponse{Success: true, Message: "Relation updated successfully", Data: nil})
}
...
func (h *ProductCategoryHandler) Delete(ctx *gin.Context) {
	...
	ctx.JSON(http.StatusOK, models.WebResponse{Success: true, Message: "Relation deleted successfully", Data: nil})
}
